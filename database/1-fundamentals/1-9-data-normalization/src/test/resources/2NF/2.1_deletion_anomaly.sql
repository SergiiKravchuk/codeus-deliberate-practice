...
update customers_1nf set reliability_score = null where ssn = 100000001;

-- TODO:  Write the query that will select all the data of Petro Cherpak to check if was updated
select * from customers_1nf where ssn = 100000001;


-- Next instructions will be provided when you run the test!
delete from customers_1nf where ssn = 100000001;