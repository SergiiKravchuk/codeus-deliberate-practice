...
-- Set scale_factor=0.005, threshold=10, analyze_scale_factor=0.005, analyze_threshold=10

-- TODO: Configure moderate autovacuum for medium-activity accounts table
-- Set scale_factor=0.1, analyze_scale_factor=0.05

-- TODO: Configure relaxed autovacuum for low-activity customers table
-- Set scale_factor=0.2, analyze_scale_factor=0.1, analyze_threshold=25
