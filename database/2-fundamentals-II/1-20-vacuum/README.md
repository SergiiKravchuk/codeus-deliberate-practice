...
2. **Exercise 2**: VACUUM with options
   - Use VACUUM VERBOSE for detailed output
   - Combine VACUUM with ANALYZE for statistics update
   - Apply comprehensive cleanup with multiple options
